...
def main() :
    ...
    df = pd.read_csv('./data\data/lang_data.csv')
    ...
    df_iris = pd.read_csv('./data\data/iris.csv')
    ...
    # 위치정보를가지고 지도에 표시하는 방법
    # 스트림릿의 map 차트

    df_location = pd.read_csv('./data\data/location.csv', index_col= 0)
    ...
    df_prog = pd.read_csv('./data\data/prog_languages_data.csv', index_col = 0)
